...
namespace DatabaseProject.Helpers
{
    public static class DataProcessor
    {
        ...
        public static void Insert<T>(IJsonProcessor<T> jsonService, IBulkInserter<T> bulkInsertService, string inputFilePath) where T : class
        {
        ...
        public static void Read<T>(IJsonProcessor<T> jsonService, IBulkExporter<T> bulkOutputService, string outputFilePath, Expression<Func<T, bool>> filter = null) where T : class
        {
        ...
        public static void Update<T, TKey>(IDataUpdater<T> updateDataService, TKey primaryKey, string propertyValue, string property) where T : class
        {
        ...
        /// <typeparam name="TKey">The type of primary key that has been applied to the entity.</typeparam>
        /// <param name="primaryKey">The type of primary key.</param>
        public static void Delete<T, TKey>(IDataDeleter<T> deleteDataService, TKey primaryKey) where T : class
        {
